...
import sys
import cv2
from bkload_dataset import load_data, load_batch
...
test_data, test_answ,train_data, train_answ = load_data(dataset,ground_truth,0.1)
...
with tf.Graph().as_default(), tf.Session() as sess:
    ...
    train_writer = tf.summary.FileWriter("loss/",sess.graph)
    ...
    for i in tqdm(range(num_train_iters)):
        ...
        [summary,loss_temp, temp] = sess.run([merged,loss_generator, train_step_gen],
